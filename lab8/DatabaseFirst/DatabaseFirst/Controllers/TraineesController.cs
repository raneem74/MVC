...
namespace DatabaseFirst.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public TraineesController(ITIContext context)
        {
            _context = context;
        }
        ...
        {
            var iTIContext = _context.Trainees.Include(t => t.Track);
        ...
        {
            ViewData["TrackId"] = new SelectList(_context.Tracks, "Id", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Email,MobileNo,Birthdate,TrackId")] Trainee trainee)
        {
            ...
            ViewData["TrackId"] = new SelectList(_context.Tracks, "Id", "Description", trainee.TrackId);
            return View(trainee);
        }
